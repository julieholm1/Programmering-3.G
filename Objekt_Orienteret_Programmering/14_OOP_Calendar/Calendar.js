...
class VideoDoor extends Door{
  constructor(containerDiv, day, sound, videoURL){
    super(containerDiv, day, sound, null) //Jeg skal have mine arugemtner fra Door-classen (Parentclass)
  ...
  addVideoBackground(){
    let video = createElement('iframe') //Er et vindue til at kigge på en anden hjemmeside
